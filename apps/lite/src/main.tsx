  ...
  return (
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <section className="stage-panel"><EditorCanvas template={devMiniCdTemplate} document={document} activeSurfaceKey={activeSurfaceKey} asset={assets[activeSurfaceKey]} onDocumentChange={setDocument} /><p className="stage-hint">Серое — trim, пунктир — safe area, внешняя красная зона — bleed.</p></section>
